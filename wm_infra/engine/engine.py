"""World model engine — user-facing sync and async execution API.

Merges:
- rollout.py (WorldModelEngine, AsyncWorldModelEngine)
- bootstrap.py (create_async_engine)
"""
...
# ---------------------------------------------------------------------------
# Bootstrap helper (from bootstrap.py)
# ---------------------------------------------------------------------------


def create_async_engine(config: EngineConfig, execution_mode: str = "chunked") -> AsyncWorldModelEngine:
    """Build the rollout engine and load model/tokenizer state if configured."""
