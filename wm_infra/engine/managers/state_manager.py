"""Latent state manager — manages latent-state caching and retrieval.

Extracted from rollout.py. The LatentStateManager owns the lifecycle of
latent state buffers for concurrent world model rollouts.
"""
...
from wm_infra.engine.types import RolloutState
