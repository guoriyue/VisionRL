"""Deterministic toy world model used for runnable RL training examples."""
...
class ToyContinuousWorldModel(WorldModel):
    ...
    The dynamics are linear enough for a policy-gradient example to learn, while
    still conforming to the same WorldModel interface as the real runtime.
    """
...
class ToyLineWorldModel(WorldModel):
    """Small 1D line-world dynamics for stable RL examples."""
