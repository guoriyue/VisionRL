...
from wm_infra.backends.cosmos_runner import CosmosRunResult, CosmosRunner
from wm_infra.backends.cosmos_runtime import (
...
from wm_infra.backends.cosmos_scheduler import CosmosChunkScheduler
...
class CosmosPredictBackend(ProduceSampleBackend):
    ...
    def _execution_entity(
        ...
        *,
        ...
        from wm_infra.backends.cosmos_runtime import CosmosBatchSignature
    ...
    async def execute_job(self, request: ProduceSampleRequest, sample_id: str) -> SampleRecord:
        ...
        result: CosmosRunResult = await asyncio.to_thread(
            self.runner.run,
        ...
        trace.record(
            CosmosStageRecord(
                ...
                chunk_size=scheduler_decision.chunk.size,
                expected_occupancy=scheduler_decision.chunk.expected_occupancy,
                metadata={"runner_mode": result.mode},
            )
        )
