    ...
    if normalized_family == "wan_2_1":
        ...
        return RayRolloutRuntimeInputs(
            runtime_spec=RolloutRuntimeSpec(
                ...
                policy_version=policy_version,
                runtime_builder=(
                    "vrl.models.families.wan_2_1.builder:build_wan_2_1_runtime_bundle"
                ),
    ...
    if normalized_family == "janus_pro":
        ...
        return RayRolloutRuntimeInputs(
            runtime_spec=RolloutRuntimeSpec(
                family="janus_pro",
                task="ar_t2i",
                build_spec=_janus_runtime_build_spec_payload(
                    cfg,
    ...
    if normalized_family == "nextstep_1":
        ...
        return RayRolloutRuntimeInputs(
            runtime_spec=RolloutRuntimeSpec(
                family="nextstep_1",
                task="ar_t2i",
                build_spec=_nextstep_1_runtime_build_spec_payload(
                    cfg,
                    device=rollout_device,
                ),
                executor_kwargs=kwargs,
...
def _janus_runtime_build_spec_payload(cfg: Any, *, device: str) -> dict[str, Any]:
    return {
...
def _nextstep_1_runtime_build_spec_payload(cfg: Any, *, device: str) -> dict[str, Any]:
    return {
