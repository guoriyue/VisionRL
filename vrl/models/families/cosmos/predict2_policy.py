...
class CosmosPredict2Policy(DiffusionPolicy):
    ...
    def forward_step(
        ...
        *,
        ...
        ``model`` overrides the default transformer (used by the trainer
        to forward through the LoRA-wrapped policy).
    ...
    def replay_forward(
        ...
        *,
        ...
        return self.forward_step(state, timestep_idx, model=model)
