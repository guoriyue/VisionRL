"""Artifact store: engine results → tmpfs as numpy files."""
...
from vrl.engine.ipc.protocol import ArtifactRef
...
class ArtifactStore:
    """Manages request artifacts on tmpfs."""
    ...
    def write_result(self, request_id: str, result: RequestOutput) -> ArtifactRef:
        """Write meta.json + result.npy to tmpfs."""
