"""Chunk scheduler: homogeneous batching by signature."""
...
class BatchSignature:
    """Grouping key for homogeneous work."""
...
class ExecutionWorkItem:
    """One schedulable unit before chunk assembly."""
...
class ExecutionChunk:
    """Homogeneous chunk for one stage pass."""
...
class ExecutionStats:
    """In-memory stats for benchmarks."""
...
class ExecutionStageRecord:
    """One stage sample in a runtime trace."""
...
class SchedulerDecision:
    """Batching decision for one signature lane."""
...
class GroupedChunkDecision(Generic[TChunk]):
    """Backend chunk + scheduler metadata."""
...
class HomogeneousChunkScheduler:
    """Group work by signature, emit fixed-size chunks."""
...
def build_execution_chunks(
    *,
    ...
    """Build chunks for a single precomputed signature."""
