"""Tests for vrl.rollouts.collectors.cosmos_predict2 (CosmosPredict2Collector)."""
...
# ---------------------------------------------------------------------------
# CosmosPredict2CollectorConfig — config defaults
# ---------------------------------------------------------------------------

class TestCosmosPredict2CollectorConfig:
    def test_defaults(self) -> None:
        """Verify config fields have correct Cosmos Predict2 defaults."""
        from vrl.rollouts.collectors.cosmos_predict2 import CosmosPredict2CollectorConfig
...
# ---------------------------------------------------------------------------
# CosmosPredict2Collector — sde_window
# ---------------------------------------------------------------------------

class TestCosmosPredict2CollectorSdeWindow:
    def test_sde_window_disabled(self) -> None:
        ...
        cfg = CosmosPredict2CollectorConfig(sde_window_size=0)
...
# ---------------------------------------------------------------------------
# CosmosPredict2Collector — init
# ---------------------------------------------------------------------------

class TestCosmosPredict2CollectorInit:
    def test_accepts_model_and_reward(self) -> None:
        """Collector initializes with model and reward function."""
        from vrl.rollouts.collectors.cosmos_predict2 import CosmosPredict2Collector
    ...
    def test_default_config(self) -> None:
        """Without explicit config, uses CosmosPredict2CollectorConfig defaults."""
        from vrl.rollouts.collectors.cosmos_predict2 import (
            CosmosPredict2Collector,
            CosmosPredict2CollectorConfig,
        )
        ...
        assert isinstance(collector.config, CosmosPredict2CollectorConfig)
        assert collector.config.num_steps == 35


# ---------------------------------------------------------------------------
# CosmosPredict2Collector — forward_step (mock)
# ---------------------------------------------------------------------------

class TestCosmosPredict2CollectorForwardStep:
    def test_forward_step_returns_noise_pred(self) -> None:
        ...
        cfg = CosmosPredict2CollectorConfig(cfg=False)
...
# ---------------------------------------------------------------------------
# CosmosPredict2Collector — seed generator selection
# ---------------------------------------------------------------------------

class TestCosmosPredict2CollectorSeedGenerator:
    def test_seed_kwarg_creates_deterministic_generator(self) -> None:
        ...
        cfg = CosmosPredict2CollectorConfig(num_steps=2, cfg=False)
        ...
        collector = CosmosPredict2Collector(model=model, reward_fn=reward, config=cfg)
