...
class TestWorldModelEnv(BaseTestCase):
    def test_world_model_env_requires_reset(self) -> None:
        env = WorldModelEnv(
            ToyLineWorldModel(),
    ...
    def test_world_model_env_reset_and_step_contract(self) -> None:
        env = WorldModelEnv(
            ToyLineWorldModel(),
            initial_state_sampler=_initial_sampler,
            goal_state_sampler=_goal_sampler,
...
class TestWorldModelVectorEnv(BaseTestCase):
    def test_world_model_vector_env_auto_reset_recycles_finished_slots(self) -> None:
