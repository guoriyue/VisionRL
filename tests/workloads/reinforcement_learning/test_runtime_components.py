...
class TestRuntimeComponents(BaseTestCase):
    def test_async_transition_dispatcher_batches_homogeneous_payloads(self) -> None:
        dispatcher = AsyncTransitionDispatcher(
            max_batch_size=2,
    ...
    def test_transition_stage_pipeline_emits_persist_intent(self, tmp_path) -> None:
    ...
    def test_transition_persistence_layer_commits_state_transition(self, tmp_path) -> None:
        store = TemporalStore(tmp_path / "temporal")
