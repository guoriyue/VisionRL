...
@pytest.mark.asyncio
class TestReinforcementLearningApi(BaseApiTestCase):
    async def test_reinforcement_learning_catalog_endpoints_expose_default_env_and_tasks(self, client):
    ...
    async def test_stateless_initialize_and_predict_transition(self, client):
    ...
    async def test_stateless_predict_many_batches_explicit_state_handles(self, client):
        init_responses = []
        for seed in (3, 9):
